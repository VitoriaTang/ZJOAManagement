$(document).ready(function () {
    $('#customWindow').jqxWindow({
        ...
        initContent: function () {
            ...
            $('#jqxFileUpload').jqxFileUpload({ width: 300, uploadUrl: 'ImportProductAction?actiontype=3', fileInputName: 'fileToUpload', multipleFilesUpload: false });
        }
    });
    ...
    var source =
    {
        ...
        id: 'ProductNumber',
        url: 'GetActionRecords?actiontype=3'
    };
